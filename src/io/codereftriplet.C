...
\*****************************************************************************/
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/folding/trunk/src/codereftriplet.C $
 | 
...
static char __attribute__ ((unused)) rcsid[] = "$Id: codereftriplet.C 2250 2013-10-25 15:11:45Z harald $";
