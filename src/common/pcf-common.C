...
\*****************************************************************************/
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/folding/trunk/src/common/common.C $
 | 
...
static char __attribute__ ((unused)) rcsid[] = "$Id: common.C 2259 2013-10-29 12:39:46Z harald $";
