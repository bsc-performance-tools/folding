...
set multiplot title "Evolution for Stall distribution model\nAppl * Task * Thread * - Group_0 - Cluster_1"
...
set ylabel 'Stalls (% over total cycles)';
set y2label 'MIPS';
set ytics nomirror;
...
slope_stalldistribution_stalls(ret,c,r,g) = (c eq 'stalldistribution_stalls' && r eq 'Cluster_1' && g == 0 ) ? ret : NaN;
slope_stalldistribution_lld(ret,c,r,g) = (c eq 'stalldistribution_lld' && r eq 'Cluster_1' && g == 0 ) ? ret : NaN;
slope_stalldistribution_lsr(ret,c,r,g) = (c eq 'stalldistribution_lsr' && r eq 'Cluster_1' && g == 0 ) ? ret : NaN;
slope_stalldistribution_lrs(ret,c,r,g) = (c eq 'stalldistribution_lrs' && r eq 'Cluster_1' && g == 0 ) ? ret : NaN;
slope_stalldistribution_rob(ret,c,r,g) = (c eq 'stalldistribution_rob' && r eq 'Cluster_1' && g == 0 ) ? ret : NaN;
slope_stalldistribution_mips(ret,c,r,g) = (c eq 'stalldistribution_mips' && r eq 'Cluster_1' && g == 0 ) ? ret : NaN;

plot \
'nemo.exe.128tasks.chop1.clustered.codeblocks.fused.any.any.any.slope.csv' u ($4 * X_LIMIT):(slope_stalldistribution_stalls($5, strcol(3), strcol(1), $2)) ti 'Stalls' axes x1y1 w lines lw 3 lc rgbcolor 'red',\
'nemo.exe.128tasks.chop1.clustered.codeblocks.fused.any.any.any.slope.csv' u ($4 * X_LIMIT):(slope_stalldistribution_lld($5, strcol(3), strcol(1), $2)) ti 'Stalls:LB' axes x1y1 w lines lw 3 lc rgbcolor 'blue',\
'nemo.exe.128tasks.chop1.clustered.codeblocks.fused.any.any.any.slope.csv' u ($4 * X_LIMIT):(slope_stalldistribution_lsr($5, strcol(3), strcol(1), $2)) ti 'Stalls:SB' axes x1y1 w lines lw 3 lc rgbcolor 'green',\
'nemo.exe.128tasks.chop1.clustered.codeblocks.fused.any.any.any.slope.csv' u ($4 * X_LIMIT):(slope_stalldistribution_lrs($5, strcol(3), strcol(1), $2)) ti 'Stalls:RS' axes x1y1 w lines lw 3 lc rgbcolor 'yellow',\
'nemo.exe.128tasks.chop1.clustered.codeblocks.fused.any.any.any.slope.csv' u ($4 * X_LIMIT):(slope_stalldistribution_rob($5, strcol(3), strcol(1), $2)) ti 'Stalls:ROB' axes x1y1 w lines lw 3 lc rgbcolor 'orange',\
'nemo.exe.128tasks.chop1.clustered.codeblocks.fused.any.any.any.slope.csv' u ($4 * X_LIMIT):(slope_stalldistribution_mips($5, strcol(3), strcol(1), $2)) ti 'MIPS' axes x1y2 w lines lw 3 lc rgbcolor 'black';
