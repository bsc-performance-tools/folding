...
$key = q/{lstlisting}[float=h,language=XML,frame=tb,basicstyle={small{{ttfamily{,keywordsP,PAPI_VEC_DP,PAPI_FP_INS,PAPI_BR_MSP<slashset><slashcpu>{lstlisting};LFS=11;AAT/;
$cached_env_img{$key} = q|<IMG
...
$key = q/{lstlisting}[float=h,language=XML,frame=tb,basicstyle={small{{ttfamily{,keywordsYC,RESOURCE_STALLS,RESOURCE_STALLS:RS<slashset><slashcpu>{lstlisting};LFS=11;AAT/;
$cached_env_img{$key} = q|<IMG
...
$key = q/{lstlisting}[float=h,language=XML,frame=tb,basicstyle={small{{ttfamily{,keywords_INS,PAPI_TOT_CYC,PAPI_L1_DCM<slashset><slashcpu>{lstlisting};MSF=1.6;LFS=11;AAT/;
$cached_env_img{$key} = q|<IMG
 WIDTH="787" HEIGHT="242" ALIGN="BOTTOM" BORDER="0"
 SRC="|."$dir".q|img10.png"
 ALT="\begin{lstlisting}[
float=h,
language=XML,
