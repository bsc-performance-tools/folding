...
\providecommand{\hlinethick}{\Xhline{\hrulethickness}} 
\lstset{framerule=\hrulethickness}

%
\providecommand{\EXTRAE}{\textsf{{E}xtrae}}%
\providecommand{\PARAVER}{\textsf{{P}araver}}%
\providecommand{\FOLDING}{\textsf{{F}olding}} 

%
\providecommand{\FOLDINGVERSION}{1.1.0rc} 
...
\bgroup \egroup
{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap159}%
\usebox{0}%
\lthtmlpictureZ
...
\begin{lstlisting}[
 ...
 captionpos=t,
 caption={Basic counter definition sets for ARMv7l / Samsung Exynos5.},
 label=lst:Extrae_counters_arm7vl_sam_exy5
]
